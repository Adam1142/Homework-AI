...
def apply_color_filter(image, filter_type):
    ...
    if filter_type == "red_tint":
        ...
        # Decreased the intensity of the blue channel
        filtered_image[:, :, 0] = cv2.subtract(filtered_image[:, :, 0], 50) # Decreased blue channel
    return filtered_image

# Load the image
image_path = 'D:\Coding\Adam\Python\AI\girl.jpg' # Provide your image path
